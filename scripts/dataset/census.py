...
from dual_uq.dataset.stages.census import CENSUS_CONFIG, run_round1_census, write_round1_report

RUN_ID = "dataset_a_census_round1_v2"

PROJECT_ROOT = ProjectPaths.discover(anchor=Path(__file__)).repository_root
DATASET_PATHS = DatasetPaths.from_project(ProjectPaths.discover(anchor=Path(__file__)))
...
CENSUS_STAGE_ROOT = DATASET_PATHS.runs / "census/round1_v2"
REPORT_PATH = DATASET_PATHS.reports / "census/round1_report.json"
