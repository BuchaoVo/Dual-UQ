...
from dual_uq.dataset_a_scale.pae import PAEMappingError, load_pae_json
...
from .identity import extract_canonical_sequence, metadata_records
from .mapping import (
    afdb_ca_by_uniprot,
...
from .observability import mechanism_evidence
...
def derive_candidate(
    ...
    try:
        ...
        if sequence["model_entity_id"] != context.expected_afdb_model_identity:
            raise DerivationError(
        ...
        result.update(
            {
                ...
                "exact_accession_prediction_record_count": sequence[
                    "prediction_record_count"
                ],
                "exact_model_identity": sequence["model_entity_id"],
                "nonselected_sibling_record_count": sequence[
