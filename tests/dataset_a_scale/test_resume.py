...
from dual_uq.dataset_a_scale.io import atomic_write_json
from dual_uq.dataset_a_scale.lifecycle import (
    evaluate_resume,
    is_terminal_status,
...
def test_stage_manifest_validator_returns_structured_failure() -> None:
    result = validate_stage_manifest({"pipeline_name": "dataset_a_scale"})
