"""Analyze frozen Stage0-2A fixed-probe structural-condition sensitivity."""
...
from dual_uq.dataset.fixed_probe_sensitivity import (
    ...
    materialize_fixed_probe_sensitivity,
    run_fixed_probe_sensitivity,
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        result = run_fixed_probe_sensitivity(paths.repository_root)
        report = materialize_fixed_probe_sensitivity(
            result, paths.repository_root / STAGE0_ROOT
        )
