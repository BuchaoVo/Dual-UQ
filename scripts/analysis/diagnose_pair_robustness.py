"""Run robust pair diagnostics with dependency-aware null tests."""
    ...
    *,
    ...
    if not residue_path.exists() or not pairwise_path.exists():
        raise FileNotFoundError(
            "Required pairwise geometry artifacts are missing; robust diagnostics "
            "cannot run without residue_geometry.parquet and pairwise_geometry.npz."
        )
