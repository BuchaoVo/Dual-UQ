...
EXP_REL="experiments/a0_validation/v2_cross_mechanism"
...
echo
echo "3/6 Check whitespace errors in the A0-V2 implementation scope"
git diff --check -- "${EXP_REL}"
...
echo
echo "Validate whitespace in the exact staged checkpoint"
